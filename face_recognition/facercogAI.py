...
class IMGclassifier(object):
    ...
    def predict_image(self, image, model, transform, class_names, threshold):
    ...
    def run_prediction(self, image, threshold=0.8):
        ...
        predicted_class = self.predict_image(image, self.model, self.transform, class_names, threshold)
